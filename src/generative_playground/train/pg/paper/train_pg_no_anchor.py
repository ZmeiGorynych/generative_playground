...
invalid_value = -3*3.5
scorer = NormalizedScorer(invalid_value=invalid_value, sa_mult=0.0, sa_thresh= -1.5, normalize_scores=True)
...
model, fitter1, fitter2 = train_policy_gradient(molecules,
                                                ...
                                                plot_prefix='no anchor ',
                                                dashboard='no anchor',#None,#
                                                save_file='paper/policy_gradient_no_anchor.h5',
                                                smiles_save_file='paper/pg_smiles_no_anchor.h5',
