...
invalid_value = -3*3.5
scorer = NormalizedScorer(invalid_value=invalid_value, sa_mult=2, sa_thresh=0, normalize_scores=True)
...
model, fitter1, fitter2 = train_policy_gradient(molecules,
                                                ...
                                                plot_prefix='anchor ',
                                                dashboard='anchor wweak',#None,#
                                                save_file='paper/policy_gradient_anchor_wweak.h5',
                                                smiles_save_file='paper/pg_smiles_anchor_wweak.h5',
