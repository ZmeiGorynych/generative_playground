...
#reward_fun_off = lambda x: 2.5 + scorer(x)#lambda x: reward_aromatic_rings(x)#
reward_fun_on = reward_aromatic_rings
...
model, fitter1, fitter2 = train_policy_gradient(molecules,
                                                ...
                                                plot_prefix='cycles ',
                                                dashboard = 'cycles',
                                                save_file='policy_gradient_cycles.h5',
                                                smiles_save_file='pg_smiles_cycles.h5',
                                                on_policy_loss_type='best+valid',
